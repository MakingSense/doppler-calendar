...
day26 = new Date("2021/10/04");
day27 = new Date("2021/10/17");
...
if (CheckPushDays(day1)) {
  ...
  spawnNotification(
    "¡Prepara tus Emails mostrando tus productos destacados y ofertas de último minuto! Y recuerda configurar tus Campañas de Carrito Abandonado, Producto Visitado y Cross Selling.",
    "",
    "7 - Comienzan las rebajas de invierno en ES y MX"
  );
  ...
  spawnNotification(
    "¡Celebra el amor y atrae clientes! Si quieres enviar Campañas que llamen la atención sin ser empalagosas, ten en cuenta estos consejos para tus Emails estacionales.",
    "",
  ...
  spawnNotification(
    "Prepara un Plan de Comunicación efectivo para Jornadas especiales de venta como esta. Antes de poner manos a la obra con tus Campañas estacionales, revisa estos ejemplos y llévate buenas ideas.",
    "",
    "31 al 2 - Hot Sale en CO"
  );
} else if (CheckPushDays(day9)) {
  spawnNotification(
    "Si hay una celebración con símbolos y elementos visuales para incluir en tus Campañas, ¡es esta! Crea los Emails más llamativos con saludos, regalos, juegos y descuentos.",
    "",
    "4 - Domingo de Pascua"
  );
  ...
  spawnNotification(
    "Aprovecha toda la información que tienes sobre cada Contacto para crear contenidos hiperpersonalizados. ¡Incluso podrías enviar una Campaña de SMS y notificarlos sobre tus mejores productos para regalar en esta fecha!",
    "",
    "9 - Día de la Madre en CO, EC, CL, PE, UY  "
  );
} else if (CheckPushDays(day14)) {
  spawnNotification(
    "¿Qué puedes esperar de este evento? Descúbrelo revisando algunas métricas de la edición pasada. También encontrarás ejemplos de Campañas enviadas por nuestros usuarios que pueden resultar inspiradoras.",
    "",
    "10 - Hot Sale en AR"
  );
} else if (CheckPushDays(day15)) {
  spawnNotification(
    "Es una fecha ideal para apelar a los sentimientos y las emociones. ¿Te animas a aplicar estos consejos de Copywriting en tus Emails? ¡Prepárate para aumentar las conversiones!",
    "",
    "20 - ¡Un mes para el Día del Padre!"
  );
  ...
  spawnNotification(
    "Todo el mundo estará hablando de esto, y tú no puedes quedarte atrás. Prepara una estrategia de Redes Sociales acorde y aumenta el Engagement con tu audiencia. ¿Te animas a usar TikTok para lograr mayor viralización y posicionamiento de tu marca?",
    "",
    "23 - Comienzan los Juegos Olímpicos "
  );
} else if (CheckPushDays(day22)) {
  spawnNotification(
    "1 de cada 2 compras comienzan o se concretan por canales online. Descubre las herramientas que te ayudarán a digitalizar tu negocio y poner a punto tu estrategia.",
    "",
    "8 - Día del Niño en CL, UY"
  );
} else if (CheckPushDays(day23)) {
  spawnNotification("", "", "15 - Día del Niño en AR, PE ");
} else if (CheckPushDays(day24)) {
  spawnNotification(
    "¿Tu negocio se relaciona con el sector educativo? ¡Esta es una fecha que no puedes dejar pasar! Conoce algunas estrategias de Marketing efectivas y diseña tus Campañas aprovechando las Plantillas temáticas de regreso a clases.",
    "",
    "10 - Comienzan las clases en ES y MX"
  );
} else if (CheckPushDays(day25)) {
  spawnNotification("", "", "30 - ¡Un mes para Halloween!");
} else if (CheckPushDays(day26)) {
  spawnNotification("", "", "4 al 6 - Cyberdays en CO");
  ...
  spawnNotification(
    "Mezcla en partes iguales segmentación, personalización y automatización para crear las Campañas más inquietantes. Truco extra: combínalas con el Envío Inteligente y llega a cada persona en el momento justo.",
    "",
    "31 - Halloween"
  );
  ...
  spawnNotification(
    "Súmate a esta movida mundial y prepara tu E-commerce para las semanas con más ventas de todo el año. Repasa esta checklist y conoce cuáles son los Emails que no pueden faltar en tu Tienda Online.",
    "",
    "26 - Black Friday"
  );
  ...
  spawnNotification(
    "¿Quieres terminar el año de la mejor manera? Encuentra las claves para tu estrategia de Email & Automation Marketing en este Workshop especial de Navidad. Luego, planifica y calendariza tus envíos fácilmente con este recurso descargable.",
    "",
    "25 - Navidad"
  );
} else if (CheckPushDays(day37)) {
  spawnNotification(
    "Es hora de preparar tu estrategia para esta fecha especial, inspírate con ejemplos de las mejores Campañas para el Hot Sale. Luego, descubre qué tan encaminada está tu estrategia para las Jornadas comerciales y comprueba qué tan cerca estás del éxito.",
    "",
    "23 al 31 - Hot Sale MX"
  );
}
